...
export default class Gallery {
  constructor ({ element, geometry, index, gl, scene, sizes }) {
    ...
    this.elementsWrapper = element.querySelector('.company__gallery__wrapper')
  ...
  createMedias () {
    this.mediasElements = this.element.querySelectorAll('.company__gallery__media') // prettier-ignore
