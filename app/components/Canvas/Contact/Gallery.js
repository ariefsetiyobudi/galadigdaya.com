...
export default class Gallery {
  constructor ({ element, geometry, index, gl, scene, sizes }) {
    ...
    this.elementsWrapper = element.querySelector('.contact__gallery__wrapper')
  ...
  createMedias () {
    this.mediasElements = this.element.querySelectorAll('.contact__gallery__media') // prettier-ignore
