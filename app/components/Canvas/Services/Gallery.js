...
export default class Gallery {
  constructor ({ element, geometry, index, gl, scene, sizes }) {
    ...
    this.elementsWrapper = element.querySelector('.services__gallery__wrapper')
    this.geometry = geometry
    this.index = index
    this.gl = gl
    this.scene = scene
    this.sizes = sizes
    this.content = document.querySelector('.services__content')
  ...
  createMedias () {
    this.mediasElements = this.element.querySelectorAll('.services__gallery__media')
